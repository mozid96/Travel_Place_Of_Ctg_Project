...
public class NearestPlaceActivity extends AppCompatActivity {
    ListView listView;
    String Entry[] = {"Cox's Bazar", "Rangamati", "Mohamia Lake",
            "Bandorban", "Kaptai", "Sitakonda", "Parky chor", "Nafakom WaterFalls"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(NearestPlaceActivity.this, DetailsActivity.class);
                intent.putExtra("key", adapter.getItem(i));
                intent.putExtra("actionBartitle", Entry[i]);
                Toast.makeText(NearestPlaceActivity.this, adapter.getItem(i), Toast.LENGTH_SHORT).show();
