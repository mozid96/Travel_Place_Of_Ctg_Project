...
public class BarisalActivity extends AppCompatActivity {
    ListView listView;
    String Entry[]={"Koakata","shapla gram,satla","Durgasagor dighi",
            "Guthia Mosque","Miabari jame Mosque"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent= new Intent(BarisalActivity.this,DetailsActivity.class);
                intent.putExtra("key",adapter.getItem(i));
                intent.putExtra("actionBartitle",Entry[i]);
                Toast.makeText(BarisalActivity.this, adapter.getItem(i) , Toast.LENGTH_SHORT).show();
