...
public class KhulnaActivity extends AppCompatActivity {
    ListView listView;
    String Entry[] = {"Sundarban", "60 gombuj mosque", "Mongla Port",
            "Dublar Chor", "Kotka Beach", "KhanJahan Ali Mousque", "Ropsa River",
            "Prem Kanon", "Lapsa", "Nat Mondir"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(KhulnaActivity.this, DetailsActivity.class);
                intent.putExtra("key", adapter.getItem(i));
                intent.putExtra("actionBartitle", Entry[i]);
                Toast.makeText(KhulnaActivity.this, adapter.getItem(i), Toast.LENGTH_SHORT).show();
